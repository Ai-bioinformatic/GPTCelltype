library(openai)
value_between=openai:::value_between
both_specified=openai:::both_specified
is_false=openai:::is_false
verify_mime_type=openai:::verify_mime_type

my_create_chat_completion= function (model, messages = NULL, temperature = 1, top_p = 1, 
          n = 1, stream = FALSE, stop = NULL, max_tokens = NULL, presence_penalty = 0, 
          frequency_penalty = 0, logit_bias = NULL, user = NULL, openai_api_key = Sys.getenv("OPENAI_API_KEY"), 
          openai_organization = NULL) 
{
  ...
  base_url <- glue::glue("https://api.xty.app/v1/{task}")
...
# # 解锁包中的绑定
# unlockBinding("create_chat_completion", asNamespace("openai"))
# 
# # 重新分配修改后的函数
# assignInNamespace("create_chat_completion", my_create_chat_completion, ns = "openai")
# 
# # 重新锁定绑定
# lockBinding("create_chat_completion", asNamespace("openai"))
